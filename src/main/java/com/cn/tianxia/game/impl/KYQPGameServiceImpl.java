 ...
 * @version 1.0.0
 */
public class KYQPGameServiceImpl implements GameReflectService{
    ...
    public static void main(String[] args) {
        ...
        pmap.put("KYQP",
                "{'api_url':'http://api.ky34.com/channelHandle?','pull_url':'http://api.ky34.com/getRecordHandle?','api_deskey':'710a445d63e446ba','api_md5key':'fdea42b76b034924','api_cagent':'30016','lineCode':'1'}");
        KYQPGameServiceImpl k = new KYQPGameServiceImpl(pmap);
        String msg = "";
        // msg=k.checkOrCreateGameAccout("linbaba666", "192.168.0.235","620");
        // msg=k.queryUnderTheBalance("linbaba666");
        msg = k.channelHandleOn("linbaba666", "300161517647634005linbaba666", "200", "3");
