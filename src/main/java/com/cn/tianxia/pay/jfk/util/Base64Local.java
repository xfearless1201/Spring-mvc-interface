 ...
 * @author hardyHuang
 */
public class Base64Local{
  private static final char[] CA = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".toCharArray();
  private static final int[] IA = new int[256];

  static { Arrays.fill(IA, -1);
    int i = 0; for (int iS = CA.length; i < iS; i++)
      IA[CA[i]] = i;
    IA[61] = 0;
  }
  ...
  public static final char[] encodeToChar(byte[] sArr, boolean lineSep)
  {
    ...
    int s = 0; int d = 0; for (int cc = 0; s < eLen; )
    {
      ...
      if (lineSep) { cc++; if ((cc == 19) && (d < dLen - 2)) {
          dArr[(d++)] = '\r';
          dArr[(d++)] = '\n';
          cc = 0;
        }
  ...
  public static final byte[] decodeFast(char[] sArr)
  {
    ...
    int sIx = 0; int eIx = sLen - 1;
    do
    {
      sIx++;

      if (sIx >= eIx) break;  } while (IA[sArr[sIx]] < 0);
  ...
  public static final byte[] decodeFast(byte[] sArr)
  {
    ...
    do
    {
      ...
      if (sIx >= eIx) break;  } while (IA[(sArr[sIx] & 0xFF)] < 0);
  ...
  public static final byte[] decodeFast(String s)
  {
    ...
    do
    {
      ...
      if (sIx >= eIx) break;  } while (IA[(s.charAt(sIx) & 0xFF)] < 0);
