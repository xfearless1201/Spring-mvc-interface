...
@SuppressWarnings({ "rawtypes", "unchecked", "restriction", "deprecation" })
public class SimpleHttpUtils {
	private static final Logger logger = Logger.getLogger(SimpleHttpUtils.class);

	public static class HTTP_TYPE {
		public static final String OK = "200";
		public static final String FILD = "500";
	 ...
	 * 默认超时设置(20秒)
	 */
	public static final int DEFAULT_READ_TIMEOUT = 100000;
	...
	public static String httpPost(String url, Map params, int timeOut) {
		return httpRequest(url, params, HTTP_METHOD_POST, DEFAULT_CHARSET, null, timeOut);
	}

	public static String httpGet(String url, Map params, int timeOut) {
		return httpRequest(url, params, HTTP_METHOD_GET, DEFAULT_CHARSET, null, timeOut);
	}
	...
	public static String httpRequest(String url, Map<String, String> params, String method, String charSet,
		...
		SimpleHttpResult result = httpRequest(param, timeOut);
	 ...
	 * @return
	 */
	public static SimpleHttpResult httpRequest(SimpleHttpParam httpParam, int timeOut) {
	...
	public static void test2() {
		...
		http.setMethod("POST");
		// SimpleHttpResult request=SimpleHttpUtils.httpRequest(http,timeOut);
