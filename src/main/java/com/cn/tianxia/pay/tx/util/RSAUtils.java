...
public class RSAUtils {
	...
	public static String sign(byte[] data, String privateKey) throws Exception {
		return sign(data, privateKey, SIGNATURE_ALGORITHM_SHA512);
	}
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
		return verify(data, publicKey, sign, SIGNATURE_ALGORITHM_SHA512);
	}
	...
	public static String encryptByPrivateKey(String dataStr, String privateKey) throws Exception {
		...
		byte[] encryptedBytes = encryptByPrivateKey(dataStr.getBytes("UTF-8"), privateKey);
	...
	public static String decryptByPublicKey(String dataStr, String publicKey) throws Exception {
		...
		byte[] encryptedBytes = decryptByPublicKey(Base64Utils.decode(dataStr), publicKey);
	...
	public static void main(String[] args) throws Exception {
		...
		byte[] queryBytes = RSAUtils.encryptByPublicKey("123456".getBytes(), publicKey);
		String reqStr = Base64Utils.encode(queryBytes);
		// System.out.println(reqStr);
		// System.out.println(new
		// String(RSAUtils.decryptByPrivateKey(Base64Utils.decode(reqStr),
		// privateKey)));
		String sign = RSAUtils.sign("123456".getBytes(), privateKey);
		System.out.println(sign);
		System.out.println(RSAUtils.verify("123456".getBytes(), publicKey, sign));
	}
}
