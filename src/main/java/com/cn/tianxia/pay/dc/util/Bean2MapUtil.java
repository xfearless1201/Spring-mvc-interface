...
//	}
	...
	public static void transMap2Bean(Map<String, Object> map, Object obj) {
		...
		try {
			...
			for (PropertyDescriptor property : propertyDescriptors) {
				 ...
				 if("dffSingleMoney".equals(key))
				 {
					 System.out.println("dffSingleMoney");
				 }
				if (map.containsKey(key)) {
					...
					// 得到property对应的setter方法 http://blog.csdn.net/startupmount/article/details/18097175
					Method setter = property.getWriteMethod();
					setter.getGenericParameterTypes();
			...
			System.out.println("transMap2Bean Error "+  e.getMessage()+"  key="+key+" value="+value);
		}
	 ...
	 * @param obj
	 */
	public static void transMap2BeanStr(Map<String, Object> map, Object obj) {
		String key="";
		Class  type;
		String typeName ;
		Object value=null;
