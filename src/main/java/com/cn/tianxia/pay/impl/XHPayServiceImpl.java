...
public class XHPayServiceImpl implements PayService {
	// 接口版本
	...
	private final static Logger logger = LoggerFactory.getLogger(XHPayServiceImpl.class);

	public XHPayServiceImpl(Map<String, String> pmap) {
	...
	public String bankPay(Map<String, String> scanMap) {
		...
		logger.info("信汇网银支付表单:" + FormString + "</form></body>");
	...
	public String scanPay(Map<String, String> scanMap) {
		...
		logger.info("信汇扫码支付表单:" + FormString + "</form></body>");
		return FormString += "</form></body>";
	}
	...
	public String callback(Map<String, String> infoMap) {
		...
		if (md5_sign.equals(serverSign)) {
			logger.info("信汇支付签名成功！");
			return "success";
		}
		logger.info("信汇支付签名失败！");
		return "";
	}
