 ...
 * 
 */
public class SHBPayServiceImpl implements PayService {
	...
	private final static Logger logger = LoggerFactory.getLogger(SHBPayServiceImpl.class);

	public SHBPayServiceImpl(Map<String, String> pmap) {
	...
	public static void testbankingNotify() {
		...
		reqMap.put("order_no", order_no);
		// btc回调测试
		String resultstr = SHBPayServiceImpl.TestdoPost("http://localhost:8080/XPJ/PlatformPay/bankingNotify.do",
				reqMap, "utf-8");
	...
	public static void testScanPayNotify() {
		...
		String resultstr = SHBPayServiceImpl.TestdoPost("http://localhost:8080/XPJ/PlatformPay/scanPayNotify.do",
				reqMap, "utf-8");
		System.out.println(resultstr);
