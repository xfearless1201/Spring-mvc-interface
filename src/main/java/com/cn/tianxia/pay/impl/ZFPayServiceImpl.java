 ...
 * 
 */
public class ZFPayServiceImpl implements PayService {
	...
	private final static Logger logger = LoggerFactory.getLogger(ZFPayServiceImpl.class);

	public ZFPayServiceImpl(Map<String, String> pmap) {
	...
	public static void testbankingNotify() {
		...
		reqMap.put("order_no", order_no);
		// btc回调测试
		String resultstr = ZFPayServiceImpl.TestdoPost("http://localhost:8080/XPJ/PlatformPay/bankingNotify.do",
				reqMap, "utf-8");
	...
	public static void testScanPayNotify() {
		...
		String resultstr = ZFPayServiceImpl.TestdoPost("http://localhost:8080/XPJ/PlatformPay/scanPayNotify.do",
				reqMap, "utf-8");
		System.out.println(resultstr);
