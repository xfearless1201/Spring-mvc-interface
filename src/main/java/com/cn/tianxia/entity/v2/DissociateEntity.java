...
/**
 * 
 * @ClassName DissociateEntity
 * @Description 用户游离表实体类
 * @author Hardy
 * @Date 2019年2月6日 下午3:57:09
 * @version 1.0.0
 */
public class DissociateEntity implements Serializable{
    
    private static final long serialVersionUID = -2712181850933317613L;
