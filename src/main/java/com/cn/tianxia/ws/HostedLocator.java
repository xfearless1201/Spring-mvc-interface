...
public class HostedLocator extends org.apache.axis.client.Service implements com.cn.tianxia.ws.Hosted {
    ...
    public com.cn.tianxia.ws.HostedSoap getHostedSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cn.tianxia.ws.HostedSoapStub _stub = new com.cn.tianxia.ws.HostedSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cn.tianxia.ws.HostedSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cn.tianxia.ws.HostedSoapStub _stub = new com.cn.tianxia.ws.HostedSoapStub(new java.net.URL(HostedSoap_address), this);
                _stub.setPortName(getHostedSoapWSDDServiceName());
                return _stub;
            }
        }
