...
public class LogoutPlayer  implements java.io.Serializable {
    private com.cn.tianxia.ws.LogoutPlayerRequest req;

    public LogoutPlayer() {
    }

    public LogoutPlayer(
           com.cn.tianxia.ws.LogoutPlayerRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.cn.tianxia.ws.LogoutPlayerRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.cn.tianxia.ws.LogoutPlayerRequest req) {
        this.req = req;
    }
