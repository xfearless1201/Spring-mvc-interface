...
public class GameClientDbDTO  implements java.io.Serializable {
    ...
    private com.cn.tianxia.ws.GameTranslationDTO[] translatedNames;
    ...
    public GameClientDbDTO(
           ...
           com.cn.tianxia.ws.GameTranslationDTO[] translatedNames) {
     ...
     */
    public com.cn.tianxia.ws.GameTranslationDTO[] getTranslatedNames() {
        return translatedNames;
    }
     ...
     */
    public void setTranslatedNames(com.cn.tianxia.ws.GameTranslationDTO[] translatedNames) {
        this.translatedNames = translatedNames;
    }
