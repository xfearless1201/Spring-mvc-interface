...
public class ReportGameOverviewPlayer  implements java.io.Serializable {
    private com.cn.tianxia.ws.PlayerReportRequest req;

    public ReportGameOverviewPlayer() {
    }

    public ReportGameOverviewPlayer(
           com.cn.tianxia.ws.PlayerReportRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.cn.tianxia.ws.PlayerReportRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.cn.tianxia.ws.PlayerReportRequest req) {
        this.req = req;
    }
