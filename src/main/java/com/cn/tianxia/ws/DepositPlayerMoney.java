...
public class DepositPlayerMoney  implements java.io.Serializable {
    private com.cn.tianxia.ws.DepositPlayerMoneyRequest req;

    public DepositPlayerMoney() {
    }

    public DepositPlayerMoney(
           com.cn.tianxia.ws.DepositPlayerMoneyRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.cn.tianxia.ws.DepositPlayerMoneyRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.cn.tianxia.ws.DepositPlayerMoneyRequest req) {
        this.req = req;
    }
