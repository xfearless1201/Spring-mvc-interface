...
public class GameResponse  extends com.cn.tianxia.ws.BaseResponse  implements java.io.Serializable {
    private java.lang.String hostedLaunchUrl;

    private com.cn.tianxia.ws.GameClientDbDTO[] games;
    ...
    public GameResponse(
           ...
           com.cn.tianxia.ws.GameClientDbDTO[] games) {
     ...
     * @return games
     */
    public com.cn.tianxia.ws.GameClientDbDTO[] getGames() {
        return games;
    }
     ...
     * @param games
     */
    public void setGames(com.cn.tianxia.ws.GameClientDbDTO[] games) {
        this.games = games;
    }
