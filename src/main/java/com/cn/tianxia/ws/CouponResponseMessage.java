...
public class CouponResponseMessage  implements java.io.Serializable {
    ...
    private com.cn.tianxia.ws.InfoMessage error;
    ...
    public CouponResponseMessage(
           ...
           int freeSpins,
           com.cn.tianxia.ws.InfoMessage error,
           boolean setToActive) {
     ...
     * @return error
     */
    public com.cn.tianxia.ws.InfoMessage getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(com.cn.tianxia.ws.InfoMessage error) {
        this.error = error;
    }
