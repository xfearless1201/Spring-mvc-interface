...
public class GameDisplayResponse  extends com.cn.tianxia.ws.BaseResponse  implements java.io.Serializable {
    private com.cn.tianxia.ws.Game[][] gameDisplay;

    public GameDisplayResponse() {
    }

    public GameDisplayResponse(
           com.cn.tianxia.ws.Game[][] gameDisplay) {
     ...
     * @return gameDisplay
     */
    public com.cn.tianxia.ws.Game[][] getGameDisplay() {
        return gameDisplay;
    }
     ...
     * @param gameDisplay
     */
    public void setGameDisplay(com.cn.tianxia.ws.Game[][] gameDisplay) {
        this.gameDisplay = gameDisplay;
    }
