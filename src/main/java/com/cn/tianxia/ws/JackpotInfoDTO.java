...
public class JackpotInfoDTO  implements java.io.Serializable {
    ...
    private com.cn.tianxia.ws.JackpotValueDTO[] conversions;
    ...
    public JackpotInfoDTO(
           ...
           com.cn.tianxia.ws.JackpotValueDTO[] conversions,
     ...
     * @return conversions
     */
    public com.cn.tianxia.ws.JackpotValueDTO[] getConversions() {
        return conversions;
    }
     ...
     * @param conversions
     */
    public void setConversions(com.cn.tianxia.ws.JackpotValueDTO[] conversions) {
        this.conversions = conversions;
    }
