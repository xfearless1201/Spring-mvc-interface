...
public class QueryPlayerResponse implements java.io.Serializable {
	...
	public QueryPlayerResponse(boolean found, java.lang.String playerId, java.lang.String brandId,
			java.lang.String brandName, java.math.BigDecimal realBalance, java.lang.String currencyCode,
			java.lang.String currencySymbol, java.lang.String token, boolean hasBonus,
			java.math.BigDecimal bonusBalance, int bonusSpins, int bonusGameId, java.lang.String bonusGameKeyName,
			java.math.BigDecimal bonusPercentage, java.math.BigDecimal bonusWagerRemaining, java.lang.String message,
			java.math.BigDecimal pointBalance) {
		this.found = found;
		...
		this.setPointBalance(pointBalance);
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof QueryPlayerResponse))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.found == other.isFound()
				&& ((this.playerId == null && other.getPlayerId() == null)
						|| (this.playerId != null && this.playerId.equals(other.getPlayerId())))
				&& ((this.brandId == null && other.getBrandId() == null)
						|| (this.brandId != null && this.brandId.equals(other.getBrandId())))
				&& ((this.brandName == null && other.getBrandName() == null)
						|| (this.brandName != null && this.brandName.equals(other.getBrandName())))
				&& ((this.realBalance == null && other.getRealBalance() == null)
						|| (this.realBalance != null && this.realBalance.equals(other.getRealBalance())))
				...
				&& ((this.currencySymbol == null && other.getCurrencySymbol() == null)
						|| (this.currencySymbol != null && this.currencySymbol.equals(other.getCurrencySymbol())))
				...
				&& ((this.bonusBalance == null && other.getBonusBalance() == null)
						|| (this.bonusBalance != null && this.bonusBalance.equals(other.getBonusBalance())))
				&& this.bonusSpins == other.getBonusSpins() && this.bonusGameId == other.getBonusGameId()
				&& ((this.bonusGameKeyName == null && other.getBonusGameKeyName() == null)
						|| (this.bonusGameKeyName != null && this.bonusGameKeyName.equals(other.getBonusGameKeyName())))
				&& ((this.bonusPercentage == null && other.getBonusPercentage() == null)
						|| (this.bonusPercentage != null && this.bonusPercentage.equals(other.getBonusPercentage())))
				...
				&& ((this.getPointBalance() == null && other.getPointBalance() == null)
						|| (this.pointBalance != null && this.pointBalance.equals(other.getPointBalance())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPointBalance() != null) {
			_hashCode += getPointBalance().hashCode();
		}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			QueryPlayerResponse.class, true);
	...
	static {
		...
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("pointBalance");
		elemField.setXmlName(new javax.xml.namespace.QName("http://ws.oxypite.com/", "PointBalance"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "decimal"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
	}
