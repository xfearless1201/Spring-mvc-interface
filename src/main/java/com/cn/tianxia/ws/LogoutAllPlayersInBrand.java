...
public class LogoutAllPlayersInBrand  implements java.io.Serializable {
    private com.cn.tianxia.ws.LogoutAllPlayersInBrandRequest req;

    public LogoutAllPlayersInBrand() {
    }

    public LogoutAllPlayersInBrand(
           com.cn.tianxia.ws.LogoutAllPlayersInBrandRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.cn.tianxia.ws.LogoutAllPlayersInBrandRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.cn.tianxia.ws.LogoutAllPlayersInBrandRequest req) {
        this.req = req;
    }
