...
public class WithdrawPlayerMoney  implements java.io.Serializable {
    private com.cn.tianxia.ws.WithdrawPlayerMoneyRequest req;

    public WithdrawPlayerMoney() {
    }

    public WithdrawPlayerMoney(
           com.cn.tianxia.ws.WithdrawPlayerMoneyRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public com.cn.tianxia.ws.WithdrawPlayerMoneyRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(com.cn.tianxia.ws.WithdrawPlayerMoneyRequest req) {
        this.req = req;
    }
